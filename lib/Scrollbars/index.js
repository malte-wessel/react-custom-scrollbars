...
exports.default = (0, _react.createClass)({
    ...
    propTypes: {
        ...
        autoWidthMin: _react.PropTypes.oneOfType([_react.PropTypes.number, _react.PropTypes.string]),
        autoWidthMax: _react.PropTypes.oneOfType([_react.PropTypes.number, _react.PropTypes.string]),
    ...
    _update: function _update(callback) {
        ...
        var container = _refs11.container;
    ...
    render: function render() {
        ...
        var autoWidth = _props5.autoWidth;
        var autoWidthMin = _props5.autoWidthMin;
        var autoWidthMax = _props5.autoWidthMax;
        var style = _props5.style;
        var children = _props5.children;

        var props = _objectWithoutProperties(_props5, ['onScroll', 'onScrollFrame', 'onScrollStart', 'onScrollStop', 'renderView', 'renderTrackHorizontal', 'renderTrackVertical', 'renderThumbHorizontal', 'renderThumbVertical', 'autoHide', 'autoHideTimeout', 'autoHideDuration', 'thumbSize', 'thumbMinSize', 'universal', 'autoHeight', 'autoHeightMin', 'autoHeightMax', 'autoWidth', 'autoWidthMin', 'autoWidthMax', 'style', 'children']);
        ...
        return _react2.default.createElement(
            'div',
            _extends({}, props.className ? { className: props.className } : {}, { style: containerStyle, ref: 'container' }),
            _react2.default.createElement(
                'div',
                { style: viewStyle, ref: 'view' },
                _react2.default.createElement(
                    'div',
                    { style: viewWrapperStyle, ref: 'viewWrapper' },
                    (0, _react.cloneElement)(renderView({ style: viewWrappedStyle }), { ref: 'viewWrapped' }, children)
                )
            ),
